...
namespace _05._3_CoinBox
{
    class CoinBox
    {
        ...
        {
            box = SeedMoney; // this is a shallow copy, consider why we might need a deep copy
        }
        ...
        public int HalfDollarCount
        {
            get
            {
                var halfDollarRoll =
                    from coin in box
                    where coin.DenominationEnumeral == Coin.Denomination.HALFDOLLAR 
                    select coin;
        ...
        public int QuarterCount
        {
            get
            {
                var quarterRoll =
                    from coin in box
                    where coin.DenominationEnumeral == Coin.Denomination.QUARTER
                    select coin;
        ...
        public int DimeCount
        {
            get
            {
                var dimeRoll =
                    from coin in box
                    where coin.DenominationEnumeral == Coin.Denomination.DIME
                    select coin;
        ...
        public int NickelCount
        {
            get
            {
                var nickelRoll =
                    from coin in box
                    where coin.DenominationEnumeral == Coin.Denomination.NICKEL
                    select coin;
        ...
        public int SlugCount
        {
            get
            {
                var slugRoll =
                    from coin in box
                    where coin.DenominationEnumeral == Coin.Denomination.SLUG
                    select coin;
